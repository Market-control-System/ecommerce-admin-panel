...
import userApiController from '@/api-service/userApiController';
    ...
    actions: {
        ...
        async login(loginData) {
            ...
            */
            ...
            const resultLogin = await userApiController.login({
                login: loginData.loginAuth,
                password: loginData.passwordAuth,
            });
